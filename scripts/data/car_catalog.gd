...
static func _get_source_entries() -> Array[Dictionary]:
		...
		_cars_cache = [
	{
		...
		"description": "Самая точная и быстрая машина стартового набора. На первом проходе числится закрытой для игрока, но может достаться сильному сопернику.",
		"locked": true,
	...
	},
	{
		...
		"description": "Мощная тяжёлая машина для стабильной прямой. В поворотах требует раннего сброса газа, зато держит сильный разгон после апекса.",
		"locked": false,
	...
	},
	{
		...
		"description": "Лёгкая классика с мягким мотором и лучшим сцеплением в связках. Хорошо прощает ранний поворот и удерживает темп в S-секциях.",
		"locked": false,
		"status_text": "Доступна",
	...
	},
	{
		...
		"description": "Простая и дружелюбная ретро-машина с предсказуемым ускорением и спокойной реакцией на ошибки. Хорошо подходит для лёгкой сложности.",
		"locked": false,
		"status_text": "Доступна",
	...
	},
	{
		...
		"description": "Ровный городской суперкар без явных провалов. Хороший первый выбор для одиночного режима, если нужен быстрый и понятный темп.",
		"locked": false,
		"status_text": "Доступна",
